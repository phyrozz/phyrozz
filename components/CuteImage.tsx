    ...
    <div className={`relative ${wrapperClassName}`}>
      {!loaded && (
        <div className="absolute inset-0 z-10 flex items-center justify-center bg-cream/70 backdrop-blur-[1px]">
          <div className="flex flex-col items-center gap-2 rounded-full border border-honey/40 bg-cream/90 px-4 py-2 shadow-sm">
            ...
            <div className="flex items-center gap-1 text-[0.65rem] font-extrabold uppercase tracking-[0.22em] text-brown-light">
              <Sparkles size={10} className="text-honey" aria-hidden="true" />
              Loading
              <Sparkles size={10} className="text-honey" aria-hidden="true" />
            </div>
          </div>
